...
<body>
			...
			<p class="wrap">
				...
				<nav id="topmenu">
					<ul class="menu">
                        ...
                        <li><p style="border-radius:50%;background-color:white;border-width:10px;" ></p></li>
	...
	<div id="head">    <!--슬라이드내용-->
			...
			<div class="slideContentContainer">
				<div id="gmnextslide" class="slideContentMover">
					<div class="slideContent">
						<ul>
							<li><a href="1.jpg"><img src="{{asset($imgpath.'/1.jpg')}}" alt="1918 Royal Cadillac" /></a></li>
							<li><a href="2.jpg"><img src="{{asset($imgpath.'/2.jpg')}}" alt="1918 Royal Cadillac" /></a></li>
							<li><a href="3.jpg"><img src="{{asset($imgpath.'/3.jpg')}}" alt="Winstorm" /></a></li>
							<li><a href="4.jpg"><img src="{{asset($imgpath.'/4.jpg')}}" alt="Winstorm" /></a></li>
						</ul>
					</div>
					<div class="slideContent">
						<ul>
			...
			<div class="slideBtnSet">
				<img id="gmnextprev" class="prevbtn" src="{{asset($imgpath.'/prev.jpg')}}" alt="prev">
				<img id="gmnextnext" class="nextbtn" src="{{asset($imgpath.'/next.jpg')}}" alt="next">
			</div>
		</div>
