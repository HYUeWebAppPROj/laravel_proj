...
<body>
	...
	<div id="slider">
	  ...
	  <ul>
	    <li><img class="imgad" src="{{asset($imgpath.'/html.jpg')}}"/></li>
	    <li><img class="imgad" src="{{asset($imgpath.'/css.jpg')}}"/></li>
	    <li><img class="imgad" src="{{asset($imgpath.'/js.png')}}"/></li>
	    <li><img class="imgad" src="{{asset($imgpath.'/php.jpg')}}"/></li>
	  </ul>  
	</div>
	<div class="wrap">
		<div id="head">
