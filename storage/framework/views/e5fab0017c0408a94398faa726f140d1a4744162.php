...
<head>
    ...
    <?php echo e(HTML::style('css/mainpage3.css')); ?>

    <?php echo e(HTML::style('css/slider3.css')); ?>

    <?php echo e(HTML::style('css/nav_mainpage.css')); ?>
...
<body>
	<header>
		<!--<div class="wrap">
            ...
            -->
			<?php echo $__env->make("mpgnav_mainpage", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    	...
    	<div class=" flex-layout-md flex-layout-md-horizontal flex-layout-lg flex-layout-lg-horizontal  flex-layout-xlg flex-layout-xlg-horizontal" style="width:100%;">
            ...
            -->
                <ul class="rslides" id="slider2">
                    <li><a><img src="<?php echo e(asset($imgpath.'/html.jpg')); ?>"/></a></li>
                    <li><a><img src="<?php echo e(asset($imgpath.'/css.jpg')); ?>"/></a></li>
                    <li><a><img src="<?php echo e(asset($imgpath.'/js.png')); ?>"/></a></li>
                    <li><a><img src="<?php echo e(asset($imgpath.'/php.jpg')); ?>"/></a></li>
                </ul> 
            </div>
            <div style="padding-bottom:30px;" class="flex-item-md-lv1 flex-item-lg-lv1 flex-item-xlg-lv1" id="loginpart">
                ...
                <img style="margin-left: 10px;" class="account-image" src='<?php echo e(Session::get("logininfo")["avatar"]); ?>'/>
                <div >
                <!--<a href="./logout" style="float:right"><button>Log out</button></a>-->
                <!--apply below===========================================-->
                        <div id="textid">
                            환영합니다!</br>
                            <span ></span><?php echo e(Session::get("logininfo")["name"]); ?>님</span>
                        </div>
	...
	<div id=topAutoScroll>
		<img src="<?php echo e(asset($imgpath.'/topAutoScroll.png')); ?>">
	</div>
	<script>
