<nav id="navbar">
	...
	<img class="menu-usr-icon" ng-click="popup.userinfo.show=!popup.userinfo.show" style="float:right;height:90%;padding:0px;border-radius:50%;cursor:pointer;" src='<?php echo e(Session::get("logininfo")["avatar"]); ?>'>
	<?php } ?>
