...
<head>
    ...
    <?php echo e(HTML::style('css/hover_table.css')); ?>
...
<body ng-app="codingApp" ng-controller="MainCtrl">
    ...
    <nav>
        ...
        <img class="menu-usr-icon" ng-click="popup.userinfo.show=!popup.userinfo.show" style="height:90%;padding:0px;border-radius:50%;cursor:pointer;" src='<?php echo e(Session::get("logininfo")["avatar"]); ?>'>
