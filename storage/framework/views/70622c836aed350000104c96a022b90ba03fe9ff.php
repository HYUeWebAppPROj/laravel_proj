...
<?php echo e(HTML::style('css/mainpage2.css')); ?>
...
<section>
    <div id="slides">
        <img class="imgad" src="<?php echo e(asset($imgpath.'/html.jpg')); ?>"/>
	    <img class="imgad" src="<?php echo e(asset($imgpath.'/css.jpg')); ?>"/>
	    <img class="imgad" src="<?php echo e(asset($imgpath.'/js.png')); ?>"/>
	    <img class="imgad" src="<?php echo e(asset($imgpath.'/php.jpg')); ?>"/>
    ...
    <div class="fluid-layout" >
        <div style="padding-bottom:15px;" class="fluid-item-xlg-6 fluid-item-lg-6 fluid-item-md-6 fluid-item-sm-12 fluid-item-xsm-12">
            ...
            <p><img class="account-image" src='<?php echo e(Session::get("logininfo")["avatar"]); ?>'/>
             <a href="./logout" style="float:right"><button>Log out</button></a>
            <p style="padding-left:5px;"><?php echo e(Session::get("logininfo")["name"]); ?>님<div><a><button>내강의실</button></a></div></p> </p>
...
<?php echo e(HTML::script('js/jquery.slides.min.js')); ?>
